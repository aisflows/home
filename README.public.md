...
[Open AIS FLOWS Home](https://aisflows-home-preview.pages.dev/) ·
[Russian version](https://aisflows-home-preview.pages.dev/ru/) ·
[Open the course preview](https://aisflows-home-preview.pages.dev/course/) ·
[Read the agent index](./AI_AGENT_DISCOVERY.md)

[![AIS FLOWS Home with the Proofline release, released skills, systems, apps, and media](./assets/readme/home-overview.png)](https://aisflows-home-preview.pages.dev/)
...
[Open the course](https://aisflows-home-preview.pages.dev/course/) ·
[Browse the catalog](https://aisflows-home-preview.pages.dev/course/catalog.html) ·
[Read the course manifest](https://aisflows-home-preview.pages.dev/course/course-agent-manifest.json)

### Media

The Home includes an AIS FLOWS trailer and four AI-assisted video previews.

[Watch on the Home](https://aisflows-home-preview.pages.dev/#media) ·
...
1. Open [AIS FLOWS Home](https://aisflows-home-preview.pages.dev/).
